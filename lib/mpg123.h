...
EXPORT int mpg123_replace_reader(mpg123_handle *mh, int (*r_read) (int, void *, size_t), off_t (*r_lseek)(int, off_t, int));
...
EXPORT int mpg123_replace_reader_handle(mpg123_handle *mh, int (*r_read) (void *, void *, size_t), off_t (*r_lseek)(void *, off_t, int), void (*cleanup)(void*));
